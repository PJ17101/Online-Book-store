...
?>
  ...
  <li>
  <a href="toptenbooks.php" style="text-decoration:none">Top 10 Books</a>
  <?php /*if(isset($_SESSION['uname']))
{
...
?>
   ...
   <li  >
<!--    <a href="2new.php" class="dropbtn" style="text-decoration:none">Login/Signup</a>
...
function showSlides() {
    ...
    setTimeout(showSlides, 2000); // Change image every 2 seconds
	 ...
	 <form  class='sha' method="post" action="action_page.php">
